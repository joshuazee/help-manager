<template>
  <div class="container">
    ...
    <!-- <news-preview-modal ref="preview" :initObj="previewData"></news-preview-modal> -->
    <Modal v-model="previewFlag" width="40" title="新闻预览" class="preview-modal">
      <div class="title">
...
export default {
  ...
  methods: {
    ...
    openAddModal () {
      ...
      this.$refs.oper.modalData.title = '发布新闻'
    ...
    openEditModal (row) {
      ...
      this.$refs.oper.modalData.title = '编辑新闻'
